...
const Socials = () => {
  return (
    <ul className="socials overflow-hidden flex gap-8 tracking-[3px] text-sm uppercase fixed origin-left top-[70%] bg-black/75 text-white/60 backdrop-blur p-5 px-8 -rotate-90 left-10">
      {
